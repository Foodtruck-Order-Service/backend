...
public class FoodtruckController {
	...
	@GetMapping
	public ResponseEntity<Object> doFoodTruckListInquiry(String type, String string) {
		return null;
	}
	
	@GetMapping("/{no}")
	public ResponseEntity<Object> doFoodTruckDeatilInquiry(@PathVariable int no) {
		return null;
	}
	...
	@DeleteMapping("/{no}")
	public ResponseEntity<Object> doFoodTruckDelete(@PathVariable int no) {
		return null;
	}
